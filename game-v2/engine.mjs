...
export const SAVE_KEY = 'chinese-game-v2';
...
export const permanent = (s) => 1 + s.prestige * (C.rules().prestigeGain ?? 0.5);
export const tapValue = (s) => payout(s, 'W', 1);
export const idleRate = () => 0;
export function payout(s, scope, weight, level = s.level || 1) {
  return Math.floor(C.base(level) * weight * permanent(s));
}
